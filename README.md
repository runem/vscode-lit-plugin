...
[![](https://vsmarketplacebadge.apphb.com/rating-short/runem.lit-plugin.svg)](https://marketplace.visualstudio.com/items?itemName=runem.lit-plugin.svg)
...
# Details
This plugin utilizes the typescript language service to provide intellisense for `lit-html`. 

The typescript plugin that powers the logic (code completion, type checking, eg.) is [ts-lit-plugin](https://github.com/runem/ts-lit-plugin). Therefore issues regarding anything but syntax highlighting should be opened in [ts-lit-plugin](https://github.com/runem/ts-lit-plugin) and not this library.

Syntax highlighting files have been ported from [vscode-lit-html](https://github.com/mjbvz/vscode-lit-html) to this library.
