...
import { CodeFixAction, CompletionEntryDetails, CompletionInfo, DefinitionInfoAndBoundSpan, FormatCodeOptions, FormatCodeSettings, GetCompletionsAtPositionOptions, JsxClosingTagInfo, LanguageService, OutliningSpan, Program, QuickInfo, RenameInfo, RenameInfoOptions, RenameLocation, TextChange, UserPreferences } from "typescript";
